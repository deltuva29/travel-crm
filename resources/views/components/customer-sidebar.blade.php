<aside
    ...
    }" class="w-full lg:w-1/4 !mt-3 space-y-2 px-6 py-4 rounded-md z-depth-1 lg:block hidden">
    ...
    <nav x-show="sidebarIsVisible"
         x-transition:enter="transition ease-out duration-200"
         x-transition:enter-start="opacity-0 scale-95"
         x-transition:enter-end="opacity-100 scale-100"
         x-transition:leave="transition ease-in duration-75"
         x-transition:leave-start="opacity-100 scale-100"
         x-transition:leave-end="opacity-0 scale-95" class="space-y-1">
        ...
        <a class="active sidebar-tab-item" href="{{ route('customer.profile.settings') }}">
