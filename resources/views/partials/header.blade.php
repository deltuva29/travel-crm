    ...
    >
        ...
        <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
            ...
            >
                <li>
                    <a
                        class="flex items-center px-4 py-1 mx-2 text-sm tracking-wide bg-amber-200 hover:bg-amber-300 text-gray-700 rounded-md transition-all"
            ...
            <div x-data="{ dropdownOpen: false }" class="relative">
                ...
                >
                    <a href="{{ route('customer.profile.settings') }}" class="flex items-center px-3 py-2 mx-2 text-xs rounded-md text-gray-700 bg-gray-300 hover:bg-gray-200 transition-all">
                    ...
                    @auth('customer')
                        <a href="{{ route('logout') }}"
                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center justify-center px-4 py-2 text-sm text-gray-700 hover:text-gray-500 transition-all">
