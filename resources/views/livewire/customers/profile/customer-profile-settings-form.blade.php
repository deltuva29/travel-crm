            ...
            <div x-data="{
                ...
                <div class="w-full text-center">
                    <div class="inline-flex items-center">
                        <button class="bg-amber-200 hover:bg-amber-300 py-1.5 px-8 mr-2 rounded transition-all">
                            {{ __('Išsaugoti') }}
                        </button>
                        <button class="bg-gray-300 hover:bg-gray-200 py-2 px-2 rounded transition-all" :class="{'!bg-amber-200':!passwordIsShow }">
