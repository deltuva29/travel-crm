            ...
            <form wire:submit.prevent="updateSettings">
                <div x-data="{
                    ...
                    <div class="w-full mb-4 pl-0 lg:pl-4">
                        <input wire:model.defer="current_password" :type="passwordIsShow ? 'password' : 'text'" name="full_name" id="full_name" class="h-10 border-none rounded-md px-4 w-full bg-gray-200 focus:outline-none focus:ring-0 placeholder-gray-400" value=""
                               placeholder="{{ __('Dabartinis slaptažodis') }}"/>
                    </div>

                    <div class="w-full flex flex-wrap">
                        <div class="w-full md:w-full lg:w-1/2 mb-6 px-0 lg:px-4">
                            <input wire:model.defer="password" :type="passwordIsShow ? 'password' : 'text'" name="city" id="city" class="h-10 border-none rounded-md px-4 w-full bg-gray-200 focus:outline-none focus:ring-0 placeholder-gray-400"
                        ...
                        <div class="w-full md:w-full lg:w-1/2 mb-4">
                            <div class="h-10 bg-gray-50 flex border border-gray-200 rounded-md items-center box-border">
                                <input wire:model.defer="password_confirmation" :type="passwordIsShow ? 'password' : 'text'" name="city" id="city" class="h-10 border-none mt-1 rounded-md px-4 w-full bg-gray-200 focus:outline-none focus:ring-0 placeholder-gray-400"
                    ...
                    <div class="w-full text-center">
                        <div class="inline-flex items-center">
                            <button type="submit" class="bg-amber-200 hover:bg-amber-300 text-[#24455C] py-1.5 px-8 mr-2 rounded transition-all">
                                ...
                                <span wire:loading wire:target="updateSettings" class="flex items-center space-x-2 text-sm">
                                    <svg aria-hidden="true" class="inline w-4 h-4 text-[#24455C] animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="bg-gray-300 hover:bg-gray-200 text-[#24455C] py-2 px-2 rounded cursor-pointer transition-all" :class="{'!bg-amber-200':!passwordIsShow }">
