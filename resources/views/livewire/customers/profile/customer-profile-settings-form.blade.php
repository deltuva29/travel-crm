                ...
                <div x-data="{
                    ...
                    <div class="w-full text-center">
                        <div class="inline-flex items-center">
                            ...
                            {{ $isDisabled ? 'text-white bg-gray-400/70 hover:bg-gray-300/100' : '' }}"
                                {{ $isDisabled ? 'disabled' : ''}}>
                            ...
                            <div class="bg-gray-200 hover:bg-gray-300 text-[#24455C] py-2 px-2 rounded cursor-pointer transition-all" :class="{'!bg-amber-200':!passwordIsShow }">
