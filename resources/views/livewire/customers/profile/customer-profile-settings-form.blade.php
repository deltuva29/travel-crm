<div>
    <div class="flex gap-4 gap-y-2 text-sm flex-col lg:flex-row py-4">
        <div class="lg:flex-grow lg:flex lg:flex-col lg:pl-2"
            ...
            @endif>
            <x-tailwind-form wire:submit.prevent="updateSettings">
                <div x-data="{
                        passwordIsShow: true,
                    ...
                    <div class="w-full flex flex-wrap">
                        ...
                        <div class="w-full md:w-full lg:w-1/2 mb-4">
                            <div class="h-10 flex border-none border-gray-200 rounded-md items-center">
                                <div class="w-full tailwind-form-input-without-margin-top">
                                    <x-tailwind-form-input
                                        :show-errors="false"
                                        class="h-10 border-none rounded-md px-4 w-full bg-gray-200 focus:outline-none focus:ring-0 placeholder-gray-400"
                            ...
                            <div class="inline-flex items-center">
                                <div class="tailwind-form-input-without-margin-top">
                                    <x-tailwind-form-submit
                                        :class="implode(' ', [
                                    '!text-white !py-1.5 !px-8 !mr-2 !rounded !transition-all',
                                    $isDisabled ? '!text-white !bg-gray-400/70 hover:!bg-gray-300/100' : '!bg-amber-400 hover:!bg-amber-500',
                                ])"
                                        :disabled="$isDisabled">
                                    <span wire:loading.remove wire:target="updateSettings" class="text-sm font-normal">
                                        {{ __('Išsaugoti') }}
                                    </span>
                                        <span wire:loading wire:target="updateSettings" class="flex items-center space-x-2 text-sm">
                                            ...
                                            <span class="font-normal">{{ __('Išsaugoma...') }}</span>
                                        </span>
                                    </x-tailwind-form-submit>
                                </div>
                                <div class="bg-gray-200 hover:bg-gray-300 text-[#24455C] py-2.5 px-2 ml-2 rounded cursor-pointer transition-all" :class="{'!bg-amber-400 !text-white':!passwordIsShow }">
