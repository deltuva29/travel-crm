                ...
                <div>
                    ...
                    <label>
                        <div class="relative z-0 w-full mb-2 group">
                            <input wire:model.lazy="email" id="email" name="email" class="block py-2.5 px-0 w-full text-sm text-gray-600 bg-transparent border-0 border-b-2 dark:border-gray-300 dark:focus:border-yellow-400 focus:outline-none focus:ring-0 focus:border-yellow-400 peer @error('email') border-red-300 placeholder-red-300 focus:ring-red @enderror" placeholder=" "/>
                        </div>
                    </label>
                    @if ($email)
                        @error('email')
                ...
                <div class="mt-8">
                    ...
                    <label>
                        <div x-data="{ show: true }" class="relative z-0 w-full mb-2 group">
                            <input wire:model.lazy="password" id="password" name="password" :type="show ? 'password' : 'text'" class="block py-2.5 px-0 w-full text-sm text-gray-600 bg-transparent border-0 border-b-2 border-gray-300 dark:border-gray-300 dark:focus:border-yellow-400 focus:outline-none focus:ring-0 focus:border-yellow-400 peer @error('password') placeholder-red-300 focus:ring-red @enderror" placeholder=" "/>
                            <div class="absolute top-1/2 right-4 cursor-pointer transform -translate-y-1/2">
                                <svg class="h-4 text-gray-300 hidden" fill="none" @click="show = !show" :class="{'hidden': !show, 'block':show }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
